...
public class StatusService {
    ...
    public static final String GET_FEED_PATH = "/getfeed";
    public static final String GET_STORY_PATH = "/getstory";
    public static final String POST_STATUS_PATH = "/poststatus";
